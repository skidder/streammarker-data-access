...
func TestTokenVerificationMiddlewareGetAndNoTokenEnforcement(t *testing.T) {
...
func TestTokenVerificationMiddlewareGetWithTokenAndTokenEnforcement(t *testing.T) {
	os.Setenv("STREAMMARKER_DATA_ACCESS_API_TOKENS", "abc123,foobar")
	defer os.Setenv("STREAMMARKER_DATA_ACCESS_API_TOKENS", "")
